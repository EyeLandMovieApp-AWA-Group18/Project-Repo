...
const AuthController = {
    ...
    async deleteAccount(req, res) {
        ...
        await pool.query('DELETE FROM shared_favorites WHERE user_id = $1', [userId]);
        ...
        res.status(200).json({ message: 'Account deleted successfully, including all related data' });
    } catch (error) {
